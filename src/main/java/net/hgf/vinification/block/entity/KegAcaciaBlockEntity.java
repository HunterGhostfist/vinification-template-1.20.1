...
public class KegAcaciaBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegAcaciaBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_ACACIA_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegAcaciaBlockEntity.this.progress;
                    case 1 -> KegAcaciaBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegAcaciaBlockEntity.this.progress = value;
                    case 1: KegAcaciaBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Acacia Keg");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_acacia.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_acacia.progress");
        super.readNbt(nbt);
    }
