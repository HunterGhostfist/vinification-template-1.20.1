...
public class KegBirchBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegBirchBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_BIRCH_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegBirchBlockEntity.this.progress;
                    case 1 -> KegBirchBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegBirchBlockEntity.this.progress = value;
                    case 1: KegBirchBlockEntity.this.maxProgress = value;
                }
            }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_birch.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_birch.progress");
        super.readNbt(nbt);
    }
