...
public class KegCherryBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegCherryBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_CHERRY_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegCherryBlockEntity.this.progress;
                    case 1 -> KegCherryBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegCherryBlockEntity.this.progress = value;
                    case 1: KegCherryBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Cherry Keg");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_cherry.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_cherry.progress");
        super.readNbt(nbt);
    }
