...
public class KegCrimsonBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegCrimsonBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_CRIMSON_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegCrimsonBlockEntity.this.progress;
                    case 1 -> KegCrimsonBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegCrimsonBlockEntity.this.progress = value;
                    case 1: KegCrimsonBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Crimson Keg");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_crimson.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_crimson.progress");
        super.readNbt(nbt);
    }
