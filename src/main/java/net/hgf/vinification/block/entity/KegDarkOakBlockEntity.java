...
public class KegDarkOakBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegDarkOakBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_DARK_OAK_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegDarkOakBlockEntity.this.progress;
                    case 1 -> KegDarkOakBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegDarkOakBlockEntity.this.progress = value;
                    case 1: KegDarkOakBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Dark Oak Keg");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_dark_oak.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_dark_oak.progress");
        super.readNbt(nbt);
    }
