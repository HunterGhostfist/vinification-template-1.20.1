...
public class KegMangroveBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegMangroveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_MANGROVE_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegMangroveBlockEntity.this.progress;
                    case 1 -> KegMangroveBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegMangroveBlockEntity.this.progress = value;
                    case 1: KegMangroveBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Mangrove Keg");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_mangrove.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_mangrove.progress");
        super.readNbt(nbt);
    }
