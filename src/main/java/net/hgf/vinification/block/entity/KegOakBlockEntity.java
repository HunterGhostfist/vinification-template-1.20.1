...
public class KegOakBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegOakBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_OAK_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegOakBlockEntity.this.progress;
                    case 1 -> KegOakBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegOakBlockEntity.this.progress = value;
                    case 1: KegOakBlockEntity.this.maxProgress = value;
                }
            }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_oak.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_oak.progress");
        super.readNbt(nbt);
    }
