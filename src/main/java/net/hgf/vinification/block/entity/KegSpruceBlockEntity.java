...
public class KegSpruceBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, KegInventory {
    ...
    public KegSpruceBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.KEG_SPRUCE_BE, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index) {
                    case 0 -> KegSpruceBlockEntity.this.progress;
                    case 1 -> KegSpruceBlockEntity.this.maxProgress;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index) {
                    case 0: KegSpruceBlockEntity.this.progress = value;
                    case 1: KegSpruceBlockEntity.this.maxProgress = value;
                }
            }
    ...
    public Text getDisplayName() {
        return Text.literal("Spruce Keg");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("keg_spruce.progress", progress);
    }

    @Override
    public void readNbt(NbtCompound nbt) {
        Inventories.readNbt(nbt, inventory);
        progress = nbt.getInt("keg_spruce.progress");
        super.readNbt(nbt);
    }
