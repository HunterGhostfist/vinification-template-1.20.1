...
public class KegRecipeBuilder implements CraftingRecipeJsonBuilder {
    ...
    public KegRecipeBuilder(ItemConvertible ingredient1, ItemConvertible result, int count) {
        this.ingredient1 = Ingredient.ofItems(ingredient1);
        this.ingredient2 = Ingredient.ofItems(ModItems.WINE_BOTTLE_EMPTY);
    ...
    public static class JsonBuilder implements RecipeJsonProvider {
        ...
        public Identifier getRecipeId() {
            return new Identifier(Vinification.MOD_ID,
                    Registries.ITEM.getId(this.result).getPath() + "_from_keg");
        }
