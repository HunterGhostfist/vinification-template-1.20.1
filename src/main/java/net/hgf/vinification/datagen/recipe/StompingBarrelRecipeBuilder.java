...
public class StompingBarrelRecipeBuilder implements CraftingRecipeJsonBuilder {
    ...
    public StompingBarrelRecipeBuilder(ItemConvertible ingredient1, ItemConvertible result, int count) {
        this.ingredient1 = Ingredient.ofItems(ingredient1);
        this.ingredient2 = Ingredient.ofItems(Items.GLASS_BOTTLE);
    ...
    public static class JsonBuilder implements RecipeJsonProvider {
        ...
        public Identifier getRecipeId() {
            return new Identifier(Vinification.MOD_ID,
                    Registries.ITEM.getId(this.result).getPath() + "_from_stomping");
        }

        @Override
        public RecipeSerializer<?> getSerializer() {
            return StompingBarrelRecipe.Serializer.INSTANCE;
        }
