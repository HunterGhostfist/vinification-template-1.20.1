...
public class WineBottleGreen extends HoneyBottleItem {
    private static final int MAX_USE_TIME = 40;


    public WineBottleGreen(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 15*20*60, 0));
        }
        return stack;
    }
