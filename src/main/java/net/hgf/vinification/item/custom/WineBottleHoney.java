...
public class WineBottleHoney extends HoneyBottleItem {
    private static final int MAX_USE_TIME = 40;


    public WineBottleHoney(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 15*20*60, 0));
        }
        return stack;
    }
